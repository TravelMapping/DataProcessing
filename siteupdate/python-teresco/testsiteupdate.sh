...
if [ "$read_data" == "1" ]; then
  ...
  ./siteupdate.py $graphflag -t 1 -s railsystems.csv -d TravelMappingTest -g $graphdir -l $logdir -c $statdir -U si404 michih peperodriguez2710 | tee $logdir/testsiteupdate.log 2>&1
