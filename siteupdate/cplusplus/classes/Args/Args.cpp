...
bool
  Args::errorcheck, Args::skipgraphs, Args::help;
int
  Args::numthreads, Args::timeprecision;
const char*
  Args::exec;
std::string
  Args::highwaydatapath, Args::systemsfile, Args::databasename, Args::graphfilepath,
  Args::csvstatfilepath, Args::logfilepath, Args::nmpmergepath,
  Args::splitregionpath, Args::splitregion, Args::userlistfilepath;
std::list<std::string>
  Args::userlist;
